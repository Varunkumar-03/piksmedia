  ...
  try {
    ...
    if (categoryCount === 0) {
      const defaultCategories = [
        ...
        { name: 'Paintings', slug: 'paintings', description: 'Original Artworks', image: 'https://images.unsplash.com/photo-1579783900882-c0d3dad7b119?q=80&w=600&auto=format&fit=crop', badge: 'Artisan', availableSizes: ['16x20', '24x36'], sizeUnit: 'inches(in)' },
